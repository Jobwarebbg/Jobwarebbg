-- [[ JOBWARE V9 - TALL EDITION (57%+ HIGHER) ]] --
...
-- [[ THEME: PITCH BLACK NEVERLOSE ]] --
local Theme = {
	MainBg      = Color3.fromRGB(8, 8, 10),        -- Fast komplettes Schwarz
	SidebarBg   = Color3.fromRGB(14, 14, 18),      -- Dunkle Sidebar
	SectionBg   = Color3.fromRGB(20, 20, 25),      -- Hellerer Content Bereich
	ElementBg   = Color3.fromRGB(30, 30, 35),      -- Button Hintergrund
	Accent      = Color3.fromRGB(0, 140, 255),     -- Helles Neverlose Blau
	Text        = Color3.fromRGB(255, 255, 255),   -- Weiß
	TextDim     = Color3.fromRGB(130, 130, 140),   -- Grau
	Stroke      = Color3.fromRGB(40, 40, 50),      -- Outline
...
function JobwareLib:CreateWindow(config)
	local WinName = config.Name or "JOBWARE"
	
	-- Cleanup
	if CoreGui:FindFirstChild("JobwareV9") then CoreGui.JobwareV9:Destroy() end
	
	local ScreenGui = Instance.new("ScreenGui")
	ScreenGui.Name = "JobwareV9"
	ScreenGui.Parent = CoreGui
	ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	ScreenGui.ResetOnSpawn = false
	-- ScreenGui.IgnoreGuiInset = true -- Optional: Wenn es unter die Notch soll
	...
	-- [[ MAIN FRAME - THE TALL VERSION ]] --
	local MainFrame = Instance.new("Frame")
	MainFrame.Name = "MainFrame"
	-- HIER IST DIE ÄNDERUNG: 92% HÖHE (Fast der ganze Screen vertikal)
	MainFrame.Size = UDim2.new(0.75, 0, 0.92, 0) 
	...
	function Library:CreateTab(name)
		...
		function Tab:CreateSection(title)
			...
			function Section:AddButton(text, callback)
				...
				Button.Size = UDim2.new(0.94, 0, 0, 40)
			...
			function Section:AddToggle(text, default, callback)
				...
				local ToggleBtn = Instance.new("TextButton")
				ToggleBtn.Size = UDim2.new(0.94, 0, 0, 40)
				...
				Box.BackgroundColor3 = Toggled and Theme.Accent or Color3.fromRGB(40,40,45)
				Box.Parent = ToggleBtn
				AddCorner(Box, 4)
				
				ToggleBtn.MouseButton1Click:Connect(function()
					Toggled = not Toggled
					local c = Toggled and Theme.Accent or Color3.fromRGB(40,40,45)
					TweenService:Create(Box, TweenInfo.new(0.15), {BackgroundColor3 = c}):Play()
